...
//
 ...
 echo '<script> alert("data atual entrou no difenrenca minutos '.$data_atual.'")</script>';
 echo '<script> alert("Hora atual entrou no difenrenca horas '.$hora_atual.'")</script>';
					...
					echo '<script> alert("dia_inicial'.$dia_inicial.'")</script>';
					echo '<script> alert("mes_inicial'.$mes_inicial.'")</script>';
					echo '<script> alert("ano_inicial'.$ano_inicial.'")</script>';
					...
					echo '<script> alert("dia final'.$dia_final.'")</script>';
					echo '<script> alert("mes final'.$mes_final.'")</script>';
					echo '<script> alert("ano final'.$ano_final.'")</script>';
					...
					echo '<script> alert("ano atual'.$dia_atual.'")</script>';
					echo '<script> alert("mes atual'.$mes_atual.'")</script>';
					echo '<script> alert("dia atual'.$ano_atual.'")</script>';
					...
					*/
					...
					echo '<script> alert("$diferenca_dia_inicial '.$diferenca_dia_inicial.'")</script>';
					echo '<script> alert("$diferenca_mes_inicial '.$diferenca_mes_inicial.'")</script>';
					echo '<script> alert("$diferenca_ano_inicial '.$diferenca_ano_inicial.'")</script>';
...
echo '<script> alert("hora'.$hora.'")</script>';
echo '<script> alert("minuto'.$minuto.'")</script>';
...
echo '<script> alert("hora'.$hora_atual.'")</script>';
echo '<script> alert("minuto'.$minuto_atual.'")</script>';
echo '<script> alert("segundo'.$segundo_atual.'")</script>';
...
echo '<script> alert("hora'.$hora_final.'")</script>';
echo '<script> alert("minuto'.$minuto_final.'")</script>';
echo '<script> alert("segundo'.$segundo_final.'")</script>';
...
if($diferenca_minutos > 0){
	 echo '<script> alert("entrou no difenren;a minutos'.$diferenca_hora.'")</script>';
		...
		$diferenca_hora = $diferenca_hora - 1;
		 ...
		 if($diferenca_segundos > 0){
			  echo '<script> alert("entrou no difenren;a segundos'.$diferenca_hora.'")</script>';
		...
		$diferenca_minutos = $pega_minutos;
		  ...
		  echo '<script> alert("dioferneca_entrou_hora'.$diferenca_hora.'")</script>';
		  echo '<script> alert("dioferneca_entrou_minutos'.$diferenca_minutos.'")</script>';
		  echo '<script> alert("dioferneca_entrou_segundos'.$diferenca_segundos.'")</script>';
		   
		  echo '<script> alert("Tempo restante para o fim do evento: '.$diferenca_hora.' horas '.$diferenca_minutos.' minutos '.$diferenca_segundos.' segundos <br>")</script>';
		  }
...
//minuto atual diferenca 30
 ...
 echo '<script> alert("hora atual'. $hora_atual.'")</script>';
 echo '<script> alert("minuto atual'.  $minuto_atual.'")</script>';
  echo '<script> alert("segundo atual'.  $segundo_atual.'")</script>';
  
   echo '<script> alert("diferenca hora atual'.  $diferenca_hora_c_atual.'")</script>';
   echo '<script> alert("diferenca minutos atual'.  $diferenca_minutos_c_atual.'")</script>';
   echo '<script> alert("diferenca segundos atual'.  $diferenca_segundos_c_atual.'")</script>';



if($diferenca_minutos_c_atual > 0){
	 echo '<script> alert("entrou no difenren;a minutos atual'. $diferenca_hora_c_atual.'")</script>';
		...
		$diferenca_minutos_c_atual = $pega_minutos_atual;
		  ...
		  echo '<script> alert("dioferneca_entrou_hora'.$diferenca_hora_c_atual.'")</script>';
		  echo '<script> alert("dioferneca_entrou_minutos'.$diferenca_minutos_c_atual.'")</script>';
		  echo '<script> alert("dioferneca_entrou_segundos'.$diferenca_segundos_c_atual.'")</script>';
		   
		  echo '<script> alert("Tempo restante para o fim do evento: '.$diferenca_hora_c_atual.' horas '.$diferenca_minutos_c_atual.' minutos '.$diferenca_segundos_c_atual.' segundos")</script>';
		  }
...
$dias_total_explode = explode(".", $total_de_dias);	
	 ...
	 $horas_restantes = $total_de_horas - $sobras_horas;
	  ...
	  echo "Tempo total restante para o fim do evento: ".$total_de_dias_parte1."  Dias  ".$horas_restantes." Horas ".$total_de_minutos." Minutos ".$total_de_segundos." Segundos - Total de Horas - ".$total_de_horas." Horas  <br>"; 
		 ...
		 echo '<script> alert("entrou no total de meses")</script>';
...
echo '<script> alert("dioferneca'.$diferenca_hora.'")</script>';
echo '<script> alert("dioferneca minutos'.$diferenca_minutos.'")</script>';
echo '<script> alert("diferenca_segundos'.$diferenca_segundos.'")</script>';


if(!empty($data_inicial)){
				echo '<script> alert("antes short time'.$data_inicial.'")</script>';
				echo '<script> alert("antes short time'.$data_atual.'")</script>';
				
				}


//subtracao datas
$sub_datas = strtotime($data_atual) - strtotime($data_inicial);
if(!empty($data_inicial)){
				echo '<script> alert("'.$data_inicial.'")</script>';
				echo '<script> alert("'.$data_atual.'")</script>';
				echo '<script> alert("'.$sub_datas.'")</script>';}


//achando o tempo passado
$sub_datas1 = $sub_datas/60;
echo '<script> alert("$sub_datas/60'.$sub_datas1.'")</script>';
$sub_datas1 = explode('.',$sub_datas1);
$minutos = $sub_datas1[0];
echo '<script> alert("minutos'.$minutos.'")</script>';
$segundos = $sub_datas-($minutos*60);
echo '<script> alert("segundos'.$segundos.'")</script>';
$minutos1 = $minutos/60;
$minutos1 = explode('.',$minutos1);
$horas = $minutos1[0]; echo '<script> alert("horas'.$horas.'")</script>';
$minutos = $minutos-($horas*60);

$dias = $horas/24;
echo '<script> alert("dias'.$dias.'")</script>';

$dados1 = $horas.':'.$minutos.':'.$segundos;

//achando a diferenca do tempo passado com o tempo que tem pra acabar
$tempo_passado = ($horas*60*60)+($minutos*60)+$segundos;
$tempo_restante = $tempo*60*60;

echo '<script> alert("$tempo_restante'.$tempo_restante.'")</script>';

//se o tempo restante for menor que o passado até o momento acaba
/*if($tempo_restante<$tempo_passado){
	echo '0:0:0';
	//dando finalizado
	$sql_finaliza = "UPDATE tb_oferta SET status = 'F' WHERE id_oferta = '".$_POST['oferta']."' ";
	mysql_query($sql_finaliza);
	exit;
}*/

$dados2 = $tempo_restante - $tempo_passado;

$sub_datas1 = $dados2/60;
$sub_datas1 = explode('.',$sub_datas1);
$minutos = $sub_datas1[0];
$segundos = $dados2-($minutos*60);
$minutos1 = $minutos/60;
$minutos1 = explode('.',$minutos1);
$horas = $minutos1[0];
$minutos = $minutos-($horas*60);
$dados2 = $horas.':'.$minutos.':'.$segundos;

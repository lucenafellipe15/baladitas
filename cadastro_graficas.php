...
if($acao == 'del_grafica'){
	...
	$sql = "delete from tb_bannerprincipal where id_grafica = ".$id_grafica;
	$sql = "delete from tb_bannercentro where id_grafica = ".$id_grafica;
	$sql = "delete from tb_grafica where id_grafica = ".$id_grafica;
...
if($acao == "editar"){
	...
	$id_grafica = $_GET['id_grafica'];
	$sql = "select * from tb_grafica where id_grafica=".$id_grafica."";
...
function SomenteNumero(e){
...

	{
		...
		{	if (id_categoria.value=='0'){
			...
			if (cep.value==''){
				alert("Digite um valor cep da grafica!");
				cep.focus();
				return false;
			}
			...
			if (grafica.value==''){
				alert("Informe um nome para grafica");
				grafica.focus();
				return false;
			}
			if (data.value==''){
			...
			if (hora_inicio_grafica.value==''){
				alert("Informe uma data");
				hora_inicio_grafica.focus();
				return false;
			}
			...
			if (imagem.value==''){
				alert("Digite uma imagem para a grafica!");
				tags.focus();
				return false;
			} 
...
<script type="text/javascript">
	 ...
	 $("#hora_inicio_grafica").mask("99:99:99");
	 $("#hora_fim_grafica").mask("99:99:99");
...
<div id="meio_conteudo" class="meio_conteudo">
            <div id="iten_meio_conteudo3" class="iten_meio_conteudo3">&nbsp;
                <div class="iten_meio_conteudo_barra_graficas">&nbsp;
                </div>
                 <div class="center-forms">
                <form  onSubmit="return valida()" id="formgrafica" name="formgrafica" action="index.php?pagina=acao_cliente&id_grafica=<?php echo $dados['id_grafica']?>&acao=<?php if($acao=="editar"){echo "editar_grafica";}else{echo "cadastrar_grafica";}?>" method="post" class="im-account-form" enctype="multipart/form-data">
...
<select name="cidade" style="background-color:#fff; font-size:1em;
	font-weight:bold; text-decoration:none; color:#111; text-shadow:0 1px 1px #333;border:1px solid #111; width:200px;">
                  ...
                  <br />
                  <div class="field">
						<label>Nome da grafica:</label>
					<input type="text" class="text" name="grafica" id="grafica" value="<?=$dados['grafica'];?>" />
				  </div>
                  <br />
...
<div class="field">
                  ...
                  <br />
                  <div class="field">
						<label>Insira as palavras para que encontrem sua grafica na busca</label>
                  ...
                  <br />
                  <div class="field">
						<label>Breve Descri&ccedil;&atilde;o da grafica:</label>
						<?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;
                  ...
                  <br />
                  <div class="field">
						<label>Detalhe da graficas:</label>
                  <?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;

...
<?php 
	$sql = "select * from tb_portifolio ";
	if(!empty($filtro)){
		$sql = $sql."where portifolio like '%".$filtro."%'";	
	}	
	$sql = $sql." order by id_portifolio DESC LIMIT $inicio, $qnt";
	...
	while($dados = mysql_fetch_array($result)){
                    ...
                    echo '<div class="img_produto">
                    	<a href="#"><img src="portifolio/'.$dados['imagem'].'" width="175" height="111" border="none"/></a>
                    </div>
                    <div id="preco" class="preco">
                    	<div class="valor_total"><p align="center">'.$dados['portifolio'].'</p></div>
                    ...
                    <div id="link_produto" class="link_produto">
                        ...
                        <div class="link_site_detalhes">
                        	<p align="center"><a href="index.php?pagina=portifolios_detalhes.php?id_portifolio='.$dados['id_portifolio'].'"><img src="images/bt_comprar.png" width="61" height="17" border="none"/></a></p>
                        </div>
                    </div>';

...
<div id="box_esq">
  ...
  <?php
  $sql = "select * from tb_galeria order by id_galeria DESC LIMIT $inicio, $qnt";
  $result = mysql_query($sql)or die(msqyl_error());
  $linhas = mysql_num_rows($result);
  $dados = mysql_fetch_array($result);
  for($i=0;$i<$linhas;$i++){
   ?>
  <div style="float:left; margin:10px; width:200px; height:260px;" align="center">
   <a href="galeria/<?php echo $dados['imagem']?>" class="highslide" onclick="return hs.expand(this)">
  <img src="galeria/miniatura/<?php echo $dados['imagem']?>" alt="foto" width="200" height="200" border="0" />
  </a>
...
<?php
			...
			$sql_select_all = "select * from tb_galeria order by id_galeria DESC";
			...
			if($total_registros!=0){
					...
					echo "<a href='galeriadefotos.php?p=1' target='_self'>primeira pagina</a> ";
					...
					echo "<a href='galeriadefotos.php?p=".$i."' target='_self'>".$i."</a> ";
					}
					}
					...
					echo "<a href='galeriadefotos.php?p=".$pags."' target='_self'>ultima pagina</a> ";
			}else{?>
            <?php

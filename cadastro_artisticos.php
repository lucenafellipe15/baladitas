...
if($acao == 'del_artistico'){
	...
	$sql = "delete from tb_bannerprincipal where id_artistico = ".$id_artistico;
	$sql = "delete from tb_bannercentro where id_artistico = ".$id_artistico;
	$sql = "delete from tb_artistico where id_artistico = ".$id_artistico;
...
if($acao == "editar"){
	...
	$id_artistico = $_GET['id_artistico'];
	$sql = "select * from tb_artistico where id_artistico=".$id_artistico."";
...
function SomenteNumero(e){
...

	{
		...
		{	if (id_categoria.value=='0'){
			...
			if (cep.value==''){
				alert("Digite um valor cep da artistico!");
				cep.focus();
				return false;
			}
			...
			if (artistico.value==''){
				alert("Informe um nome para artistico");
				artistico.focus();
				return false;
			}
			if (data.value==''){
			...
			if (hora_inicio_artistico.value==''){
				alert("Informe uma data");
				hora_inicio_artistico.focus();
				return false;
			}
			...
			if (imagem.value==''){
				alert("Digite uma imagem para a artistico!");
				tags.focus();
				return false;
			} 
...
<script type="text/javascript">
	 ...
	 $("#hora_inicio_artistico").mask("99:99:99");
	 $("#hora_fim_artistico").mask("99:99:99");
...
<div id="meio_conteudo" class="meio_conteudo">
            <div id="iten_meio_conteudo3" class="iten_meio_conteudo3">&nbsp;
                <div class="iten_meio_conteudo_barra_artisticos">&nbsp;
                </div>
                 <div class="center-forms">
                <form  onSubmit="return valida()" id="formartistico" name="formartistico" action="index.php?pagina=acao_cliente&id_artistico=<?php echo $dados['id_artistico']?>&acao=<?php if($acao=="editar"){echo "editar_artistico";}else{echo "cadastrar_artistico";}?>" method="post" class="im-account-form" enctype="multipart/form-data">
...
<select name="cidade" style="background-color:#fff; font-size:1em;
	font-weight:bold; text-decoration:none; color:#111; text-shadow:0 1px 1px #333;border:1px solid #111; width:200px;">
                  ...
                  <div class="field">
						<label>Nome da artistico:</label>
					<input type="text" class="text" name="artistico" id="artistico" value="<?=$dados['artistico'];?>" />
				  </div>
...
<div class="field">
                  ...
                  <div class="field">
						<label>Insira as palavras para que encontrem sua artistico na busca</label>
                  ...
                  <div class="field">
						<label>Breve Descri&ccedil;&atilde;o da artistico:</label>
						<?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;
                  ...
                  <div class="field">
						<label>Detalhe da artisticos:</label>
                  <?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;

...
<div id="box_esq">
  ...
  <?php
  $sql = "select * from tb_professor order by id_professor DESC LIMIT $inicio, $qnt";
  ...
  <table width="649" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
    <tr>
      <td colspan="2" align="left" valign="top">
        <img src="professores/<?php echo $dados['imagem']?>" width="200" height="150" alt="foto"  style=" margin:10px; float:left;"/>
        <h3>Prof. <?php echo $dados['nome']?></h3>
...
<?php
			...
			$sql_select_all = "select * from tb_professor order by id_professor DESC";
			...
			if($total_registros!=0){
					...
					echo "<a href='professores.php?p=1' target='_self'>primeira pagina</a> ";
					...
					echo "<a href='professores.php?p=".$i."' target='_self'>".$i."</a> ";
					}
					}
					...
					echo "<a href='professores.php?p=".$pags."' target='_self'>ultima pagina</a> ";
			}else{?>
            <?php

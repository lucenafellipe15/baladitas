...
<div id="box_esq">
  ...
  <?php
  $sql = "select * from tb_cliente order by id_cliente DESC LIMIT $inicio, $qnt";
  ...
  <img src="cliente/<?php echo $dados['imagem']?>" alt="foto" width="200" height="150" border="0" />
  </a>
    <?php echo $dados['nome']?>
  </div>
   <?php
...
<?php
			...
			$sql_select_all = "select * from tb_cliente order by id_cliente DESC";
			...
			if($total_registros!=0){
					...
					echo "<a href='clientes.php?p=1' target='_self'>primeira pagina</a> ";
					...
					echo "<a href='clientes.php?p=".$i."' target='_self'>".$i."</a> ";
					}
					}
					...
					echo "<a href='clientes.php?p=".$pags."' target='_self'>ultima pagina</a> ";
			}else{?>
            <?php

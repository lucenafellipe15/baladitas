...
if($acao == 'del_portifolio'){
	...
	$sql = "delete from tb_bannerprincipal where id_portifolio = ".$id_portifolio;
	$sql = "delete from tb_bannercentro where id_portifolio = ".$id_portifolio;
	$sql = "delete from tb_portifolio where id_portifolio = ".$id_portifolio;
...
if($acao == "editar"){
	...
	$sql = "select * from tb_portifolio where id_portifolio=".$id_portifolio."";
...
function SomenteNumero(e){
...

	{
		...
		{	if (id_categoria.value=='0'){
			...
			if (cep.value==''){
				alert("Digite um valor cep da portifolio!");
				cep.focus();
				return false;
			}
			...
			if (portifolio.value==''){
				alert("Informe um nome para portifolio");
				portifolio.focus();
				return false;
			}
			if (data.value==''){
			...
			if (hora_inicio_portifolio.value==''){
				alert("Informe uma data");
				hora_inicio_portifolio.focus();
				return false;
			}
			...
			if (imagem.value==''){
				alert("Digite uma imagem para a portifolio!");
				tags.focus();
				return false;
			} 
...
<script type="text/javascript">
	 ...
	 $("#hora_inicio_portifolio").mask("99:99:99");
	 $("#hora_fim_portifolio").mask("99:99:99");
...
<div id="meio_conteudo" class="meio_conteudo">
            <div id="iten_meio_conteudo3" class="iten_meio_conteudo3">&nbsp;
                <div class="iten_meio_conteudo_barra_portifolios">&nbsp;
                </div>
                 <div class="center-forms">
                <form  onSubmit="return valida()" id="formportifolio" name="formportifolio" action="index.php?pagina=acao_cliente&id_portifolio=<?php echo $dados['id_portifolio']?>&acao=<?php if($acao=="editar"){echo "editar_portifolio";}else{echo "cadastrar_portifolio";}?>" method="post" class="im-account-form" enctype="multipart/form-data">
...
<select name="id_categoria" style="background-color:#fff; font-size:1em;
	font-weight:bold; text-decoration:none; color:#111; text-shadow:0 1px 1px #333;border:1px solid #111; width:200px;">
									<option value="0">Escolha uma Categoria</option>
										<?
												$sql_cat = "select * from tb_categoria_portifolios order by categoria_portifolios ASC";
												...
												if(mysql_num_rows <= '0'){
													...
													{
														$id_categoria = $registro['id_categoria_portifolios'];	
														...
														echo '<option value = "'.$id_categoria.'"'.$selecionado.' > '.utf8_encode($registro['categoria_portifolios']).'</option>';
													}
										?>
				  </select>
				  </div>
...
<select name="cidade" style="background-color:#fff; font-size:1em;
	font-weight:bold; text-decoration:none; color:#111; text-shadow:0 1px 1px #333;border:1px solid #111; width:200px;">
                  ...
                  <br />
                  <div class="field">
						<label>Nome da portifolio:</label>
					<input type="text" class="text" name="portifolio" id="portifolio" value="<?=$dados['portifolio'];?>" />
				  </div>
                  <br />
                  ...
                  <br />
                  <div class="field">
						<label>Insira as palavras para que encontrem sua portifolio na busca</label>
                  ...
                  <br />
                  <div class="field">
						<label>Breve Descri&ccedil;&atilde;o da portifolio:</label>
						<?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;
                  ...
                  <br />
                  <div class="field">
						<label>Detalhe da portifolios:</label>
                  <?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;

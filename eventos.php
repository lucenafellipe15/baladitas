...
<div id="box_esq">
  ...
  <?php
  $sql = "select * from tb_evento order by id_evento DESC LIMIT $inicio, $qnt";
  ...
  <table width="649" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
    <tr>
      <td colspan="2" align="left" valign="top">
        <img src="evento/<?php echo $dados['imagem']?>" width="200" height="150" alt="foto"  style=" margin:10px; float:left;"/>
...
<?php
			...
			$sql_select_all = "select * from tb_evento order by id_evento DESC";
			...
			if($total_registros!=0){
					...
					echo "<a href='eventos.php?p=1' target='_self'>primeira pagina</a> ";
					...
					echo "<a href='eventos.php?p=".$pags."' target='_self'>ultima pagina</a> ";
			}else{?>
            <?php
				echo "Nenhuma Evento Cadastrado.";
				}
			?>
</div>

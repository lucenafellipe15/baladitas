...
<!--FORMULARIO-->  
<form action="acao_cliente.php?comando=add_preinscricao" method="post" enctype="multipart/form-data" onsubmit="MM_validateForm('nome','','R','telefone','R','curso','','R','email','','R','obs','','R');" >
  <table width="644" border="0" cellspacing="5" cellpadding="5" style="background-color:#F90;">
    <tr>
    <td colspan="3" align="right" class="span"> <p>Preencha os campos abaixo com todos os dados solicitados para que possamos agilizar sua inscrição.</p></td>
    </tr>
  <tr>
    <td width="99" align="right" valign="top" class="span">Seu nome:</td>
    <td colspan="2"><input name="nome" type="text" id="nome" value="<?php echo $_POST['nome'];?>"/></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="span">Seu telefone:</td>
    <td colspan="2"><input type="text" name="telefone" id="telefone" /></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="span">Seu e-mail:</td>
    <td colspan="2"><input type="text" name="email" id="email" value="<?php echo $_POST['email'];?>"/></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="span">O Curso:</td>
    <td colspan="2" style="padding-left:10px;">
      
    <select name="curso" id="curso" style="width:200px;">
        <option value="">Selecione um Curso...</option>
        <?php 
			$sqlU = "select * from tb_curso";
			$resultU = mysql_query($sqlU) or die(mysql_error());
			$linhasU = mysql_num_rows($resultU);
			$dadosU = mysql_fetch_array($resultU);
			for($i=0;$i<$linhasU;$i++){?>
        <option value="<?php echo $dadosU['id_curso'];?>" <?php echo ($dadosU['id_curso']==$id_curso)?"selected=\"selected\"":""?>><?php echo $dadosU['curso'];?></option>
        <?php	
			$dadosU = mysql_fetch_array($resultU);
			}
			?>
  ...
  <tr>
    <td align="right" valign="top" class="span">Obs:</td>
    <td colspan="2"><textarea name="obs" id="obs" cols="30" rows="5"></textarea></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
    <td width="273" align="right"><input type="image" src="images/bt_enviar.jpg" name="button" id="button" value="Enviar" /></td>
    <td width="222">&nbsp;</td>
  </tr>
</table>

...
<div id="box_esq">
  ...
  <?php
  $sql = "select * from tb_noticia order by id_noticia DESC LIMIT $inicio, $qnt";
  ...
  <table width="649" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
    <tr>
      <td colspan="2" align="left" valign="top">
        <img src="noticia/<?php echo $dados['imagem']?>" width="200" height="150"  style=" margin:10px; float:left;"/>
...
<?php
			...
			$sql_select_all = "select * from tb_noticia order by id_noticia DESC";
			...
			if($total_registros!=0){
					...
					echo "<a href='noticias.php?p=1' target='_self'>primeira pagina</a> ";
					...
					echo "<a href='noticias.php?p=".$pags."' target='_self'>ultima pagina</a> ";
			}else{?>
            <?php
				echo "Nenhuma Notícia Cadastrado.";
				}
			?>
</div>

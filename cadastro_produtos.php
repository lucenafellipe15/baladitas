...
if($acao == 'del_produto'){
	...
	$sql = "delete from tb_bannerprincipal where id_produto = ".$id_produto;
	$sql = "delete from tb_bannercentro where id_produto = ".$id_produto;
...
function SomenteNumero(e){
...

	{
		...
		{	if (id_categoria.value=='0'){
			...
			if (cep.value==''){
				alert("Digite um valor cep da produto!");
				cep.focus();
				return false;
			}
			...
			if (produto.value==''){
				alert("Informe um nome para produto");
				produto.focus();
				return false;
			}
			if (preco.value==''){
				alert("Informe um preco para produto");
				produto.focus();
				return false;
			}
			if (data.value==''){
			...
			if (imagem.value==''){
				alert("Digite uma imagem para a produto!");
				tags.focus();
				return false;
			} 
...
<script type="text/javascript">
	 ...
	 $("#hora_inicio_produto").mask("99:99:99");
	 $("#hora_fim_produto").mask("99:99:99");
...
<div id="meio_conteudo" class="meio_conteudo">
            <div id="iten_meio_conteudo3" class="iten_meio_conteudo3">&nbsp;
                <div class="iten_meio_conteudo_barra_produtos">&nbsp;
                </div>
                 <div class="center-forms">
                <form  onSubmit="return valida()" id="formproduto" name="formproduto" action="index.php?pagina=acao_cliente&id_produto=<?php echo $dados['id_produto']?>&acao=<?php if($acao=="editar"){echo "editar_produto";}else{echo "cadastrar_produto";}?>" method="post" class="im-account-form" enctype="multipart/form-data">
...
<select name="cidade" style="background-color:#fff; font-size:1em;
	font-weight:bold; text-decoration:none; color:#111; text-shadow:0 1px 1px #333;border:1px solid #111; width:200px;">
                  ...
                  <div class="field">
					...
					<input type="text" class="text" name="produto" id="produto" value="<?=$dados['produto'];?>" />
				  </div>
                  <div class="field">
						<label>Desconto do produto:</label>
					<input type="text" class="text" name="desconto" id="desconto" value="<?=$dados['desconto'];?>" />
				  </div>
                  <div class="field">
						<label>Porcentagem de Desconto da produto:</label>
					<input type="text" class="text" name="porcentagem_desconto" id="porcentagem_desconto" value="<?=$dados['porcentagem_desconto'];?>" />
				  </div>
                  <div class="field">
						<label>Data:</label>
					<input type="text" class="text" name="data" id="data" value="<?=$dados['data'];?>" />
				  </div>
...
<div class="field">
                  ...
                  <div class="field">
						<label>Insira as palavras para que encontrem sua produto na busca</label>
                  ...
                  <div class="field">
						<label>Breve Descri&ccedil;&atilde;o da produto:</label>
						<?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;
                  ...
                  <div class="field">
						<label>Detalhe da produtos:</label>
                  <?php //CODIGO NOVO
							$sBasePath = $_SERVER['PHP_SELF'] ;
